---
title: 守约状态变化通知(JSON)
description: 用户守约状态发生变更后，微信会把用户守约状态信息通知给商户。
---

# {{ $frontmatter.title }} {#post}

{{ $frontmatter.description }} [官方文档](https://pay.weixin.qq.com/wiki/doc/apiv3/apis/chapter6_3_5.shtml)
 ...
 * @prop {'DISCOUNT_CARD.AGREEMENT_ENDED'} event_type

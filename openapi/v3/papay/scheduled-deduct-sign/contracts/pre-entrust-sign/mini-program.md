...
{{ $frontmatter.description }} [官方文档](https://pay.weixin.qq.com/docs/merchant/apis/entrusted-payment/normal/mini-program-scheduled-deduct-pre-sign.html)

```js twoslash
// @filename: virtual.ts
/// <reference types="node" />
import { AxiosRequestConfig, AxiosPromise } from 'axios'
namespace WeChatPay.OpenAPI.V3.Papay.ScheduledDeductSign.Contracts.PreEntrustSign.MiniProgram.PostHttpMethod {
...
namespace WeChatPay.OpenAPI.V3.Papay.ScheduledDeductSign.Contracts.PreEntrustSign {
  export interface MiniProgram {
    /**
     * shortland
     * @link https://pay.weixin.qq.com/docs/merchant/apis/entrusted-payment/normal/mini-program-scheduled-deduct-pre-sign.html
     */
...
// ---cut---
wxpay.v3.papay.scheduledDeductSign.contracts.preEntrustSign.miniProgram.post({
//                                                                      ^^^^
  appid,
  openid,
  plan_id,

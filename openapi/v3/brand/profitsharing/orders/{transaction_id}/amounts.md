...
namespace WeChatPay.OpenAPI.V3.Brand.Profitsharing.Orders._transaction_id_.Amounts.GetHttpMethod {
...
namespace WeChatPay.OpenAPI.V3.Brand.Profitsharing.Orders {
...
// ---cut---
wxpay.v3.brand.profitsharing.orders._transaction_id_.amounts.get({
//                                                           ^^^
  transaction_id,
})
.then(

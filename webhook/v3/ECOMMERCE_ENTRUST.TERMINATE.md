...
```json
{
  ...
  "event_type":"ECOMMERCE_ENTRUST.TERMINATE",
  "summary": "签约结果通知",
  "resource" : {
 ...
 * @prop {'ECOMMERCE_ENTRUST.TERMINATE'} event_type
 ...
 * @prop {string} appid
 * @prop {string} openid
 * @prop {'USER_TERMINATE'|'MCH_API_TERMINATE'|'WEPAY_WEB_TERMINATE'|'CUSTOM_SERVICE_TERMINATE'|'SYSTEM_TERMINATE'} contract_termination_mode

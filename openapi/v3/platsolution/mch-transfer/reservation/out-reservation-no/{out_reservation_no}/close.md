...
{{ $frontmatter.description }} [官方文档](https://pay.weixin.qq.com/docs/partner/apis/platsolution-mch-transfer/transfer-reservation/transfer-reservation-close.html)

```js twoslash
// @filename: virtual.ts
/// <reference types="node" />
import { AxiosRequestConfig, AxiosPromise } from 'axios'
namespace WeChatPay.OpenAPI.V3.Platsolution.MchTransfer.Reservation.OutReservationNo._out_reservation_no_.Close.PostHttpMethod {
...
namespace WeChatPay.OpenAPI.V3.Platsolution.MchTransfer.Reservation.OutReservationNo {
  export interface _out_reservation_no_ {
    close: _out_reservation_no_.Close
  }
}
...
// ---cut---
wxpay.v3.platsolution.mchTransfer.reservation.outReservationNo._out_reservation_no_.close.post({
//                                                                                        ^^^^
}, {
  out_reservation_no,
  params,

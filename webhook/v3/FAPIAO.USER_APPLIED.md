---
title: 用户发票抬头填写完成通知(JSON)
description: 当用户完成发票抬头信息填写后，微信支付将通知商户
---

# {{ $frontmatter.title }} {#post}

{{ $frontmatter.description }} [官方文档](https://pay.weixin.qq.com/docs/merchant/apis/fapiao/fapiao-card-template/user-invoice-rise-write-notice.html) [官方文档](https://pay.weixin.qq.com/docs/partner/apis/fapiao/fapiao-card-template/user-invoice-rise-write-notice.html)
 ...
 * @prop {'FAPIAO.USER_APPLIED'} event_type

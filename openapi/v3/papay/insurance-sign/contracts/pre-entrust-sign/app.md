...
{{ $frontmatter.description }} [官方文档](https://pay.weixin.qq.com/docs/merchant/apis/insurance-entrusted-payment/insurance/app-sign-and-create-transaction.html)

```js twoslash
// @filename: virtual.ts
/// <reference types="node" />
import { AxiosRequestConfig, AxiosPromise } from 'axios'
namespace WeChatPay.OpenAPI.V3.Papay.InsuranceSign.Contracts.PreEntrustSign.App.PostHttpMethod {
...
// ---cut---
wxpay.v3.papay.insuranceSign.contracts.preEntrustSign.app.post({
//                                                        ^^^^
  appid,
  openid,
  plan_id,

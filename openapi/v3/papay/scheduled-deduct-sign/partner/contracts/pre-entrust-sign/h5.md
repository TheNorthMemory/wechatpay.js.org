...
{{ $frontmatter.description }} [官方文档](https://pay.weixin.qq.com/docs/partner/apis/entrusted-payment/partner/partner-h5-scheduled-deduct-pre-sign.html)

```js twoslash
// @filename: virtual.ts
/// <reference types="node" />
import { AxiosRequestConfig, AxiosPromise } from 'axios'
namespace WeChatPay.OpenAPI.V3.Papay.ScheduledDeductSign.Partner.Contracts.PreEntrustSign.H5.PostHttpMethod {
...
// ---cut---
wxpay.v3.papay.scheduledDeductSign.partner.contracts.preEntrustSign.h5.post({
//                                                                     ^^^^
  sp_appid,
  sp_openid,
  sub_mchid,

...
{{ $frontmatter.description }} [官方文档](https://pay.weixin.qq.com/docs/merchant/apis/education-fee-payment/contracts-result-notification.html) [官方文档](https://pay.weixin.qq.com/docs/partner/apis/education-fee-payment/contracts-result-notification.html)
 ...
 * @prop {'ENTRUST.SIGNING'} event_type
 ...
 * @prop {string} plan_id
 * @prop {{contract_id: string, contract_status: string, create_time: string}} contract_information
 */

---
title: 商圈会员积分服务授权结果通知(JSON)
description: 商圈会员在商圈小程序内打开“商圈会员快速积分”插件并完成会员积分服务授权后，微信会把会员的授权结果通知给商圈商户。
---

# {{ $frontmatter.title }} {#post}

{{ $frontmatter.description }} [官方文档](https://pay.weixin.qq.com/wiki/doc/apiv3/apis/chapter8_6_6.shtml)
 ...
 * @prop {'MALL_AUTH.ACTIVATE_CARD'} event_type
 ...
 * @prop {string} code
 * @prop {string} mchid
 * @prop {'REGISTERED_MODE'|'REGISTERED_AND_AUTHORIZATION_MODE'} auth_type
 */

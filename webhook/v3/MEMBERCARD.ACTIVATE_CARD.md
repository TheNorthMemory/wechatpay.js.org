...
```json
{
  ...
  "event_type":"MEMBERCARD.ACTIVATE_CARD",
  "resource" : {
 ...
 * @prop {'MEMBERCARD.ACTIVATE_CARD'} event_type
 * @prop {{algorithm: string, ciphertext: string, nonce: string, associated_data: string}} resource
 *
 * @typedef PlainObject
 * @prop {'MEMBER_CARD_ACTIVATE'} event_type
 * @prop {string} event_time
 * @prop {'NEW_ACTIVATE'|'RECOVER'} activate_scene
 * @prop {string} openid
 * @prop {string} unionid
 * @prop {string} card_id
 * @prop {string} code
 * @prop {string} outer_str
 */

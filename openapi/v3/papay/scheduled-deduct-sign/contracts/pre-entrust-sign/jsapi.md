...
{{ $frontmatter.description }} [官方文档](https://pay.weixin.qq.com/docs/merchant/apis/entrusted-payment/normal/jsapi-scheduled-deduct-pre-sign.html)

```js twoslash
// @filename: virtual.ts
/// <reference types="node" />
import { AxiosRequestConfig, AxiosPromise } from 'axios'
namespace WeChatPay.OpenAPI.V3.Papay.ScheduledDeductSign.Contracts.PreEntrustSign.Jsapi.PostHttpMethod {
...
namespace WeChatPay.OpenAPI.V3.Papay.ScheduledDeductSign.Contracts.PreEntrustSign {
  export interface Jsapi {
    /**
     * shortland
     * @link https://pay.weixin.qq.com/docs/merchant/apis/entrusted-payment/normal/jsapi-scheduled-deduct-pre-sign.html
     */
...
// ---cut---
wxpay.v3.papay.scheduledDeductSign.contracts.preEntrustSign.jsapi.post({
//                                                                ^^^^
  appid,
  openid,
  plan_id,

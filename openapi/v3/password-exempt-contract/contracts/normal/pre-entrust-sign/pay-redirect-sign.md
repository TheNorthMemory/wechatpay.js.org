...
{{ $frontmatter.description }} [官方文档](https://pay.weixin.qq.com/docs/merchant/apis/password-free-contract/sign/normal-pay-redirect-sign-pre-entrust-sign.html)

```js twoslash
// @filename: virtual.ts
/// <reference types="node" />
import { AxiosRequestConfig, AxiosPromise } from 'axios'
namespace WeChatPay.OpenAPI.V3.PasswordExemptContract.Contracts.Normal.PreEntrustSign.PayRedirectSign.PostHttpMethod {
...
// ---cut---
wxpay.v3.passwordExemptContract.contracts.normal.preEntrustSign.payRedirectSign.post({
//                                                                              ^^^^
  appid,
  service_id,
  out_contract_code,

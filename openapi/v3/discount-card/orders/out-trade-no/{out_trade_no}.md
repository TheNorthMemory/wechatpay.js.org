...
{{ $frontmatter.description }} [官方文档](https://pay.weixin.qq.com/wiki/doc/apiv3/wxpay/payscore/discount-card/chapter3_1.shtml)

```js twoslash
// @filename: virtual.ts
/// <reference types="node" />
import { AxiosRequestConfig, AxiosPromise } from 'axios'
namespace WeChatPay.OpenAPI.V3.DiscountCard.Orders.OutTradeNo._out_trade_no_.GetHttpMethod {
...
// ---cut---
wxpay.v3.discountCard.orders.outTradeNo._out_trade_no_.get({
//                                                     ^^^
  out_trade_no,
})
.then(

...
namespace WeChatPay.OpenAPI.V3.Pay.Partner.Transactions.Id._transaction_id_.GetHttpMethod {
...
// ---cut---
wxpay.v3.pay.partner.transactions.id._transaction_id_.get({
  transaction_id,

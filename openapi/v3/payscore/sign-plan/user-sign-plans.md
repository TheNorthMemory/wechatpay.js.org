...
{{ $frontmatter.description }} [官方文档](https://pay.weixin.qq.com/docs/merchant/apis/payscore-plan/user-sign-plan/create-user-sign-plan.html)

```js twoslash
// @filename: virtual.ts
/// <reference types="node" />
import { AxiosRequestConfig, AxiosPromise } from 'axios'
namespace WeChatPay.OpenAPI.V3.Payscore.SignPlan.UserSignPlans.PostHttpMethod {
...
// ---cut---
wxpay.v3.payscore.signPlan.userSignPlans.post({
//                                       ^^^^
  service_id,
  plan_id,
  appid,

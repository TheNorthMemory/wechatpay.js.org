...
{{ $frontmatter.description }} [官方文档](https://pay.weixin.qq.com/docs/merchant/apis/password-free-contract/sign/normal-mini-program-pre-entrust-sign.html)

```js twoslash
// @filename: virtual.ts
/// <reference types="node" />
import { AxiosRequestConfig, AxiosPromise } from 'axios'
namespace WeChatPay.OpenAPI.V3.PasswordExemptContract.Contracts.Normal.PreEntrustSign.MiniProgram.PostHttpMethod {
...
namespace WeChatPay.OpenAPI.V3.PasswordExemptContract.Contracts.Normal.PreEntrustSign {
  export interface MiniProgram {
    /**
     * shortland
     * @link https://pay.weixin.qq.com/docs/merchant/apis/password-free-contract/sign/normal-mini-program-pre-entrust-sign.html
     */
...
namespace WeChatPay.OpenAPI.V3.PasswordExemptContract.Contracts.Normal {
...
namespace WeChatPay.OpenAPI.V3.PasswordExemptContract.Contracts {
  export interface Normal {
    preEntrustSign: Normal.PreEntrustSign
  }
}
namespace WeChatPay.OpenAPI.V3.PasswordExemptContract {
  export interface Contracts {
    normal: Contracts.Normal
  }
}
...
// ---cut---
wxpay.v3.passwordExemptContract.contracts.normal.preEntrustSign.miniProgram.post({
//                                                                          ^^^^
  appid,
  service_id,
  out_contract_code,

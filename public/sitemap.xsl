...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:sitemap="http://www.sitemaps.org/schemas/sitemap/0.9">
  <xsl:variable name="hostname" select="'wechatpay.js.org'" />
  ...
  <xsl:template match="/">
    ...
    <html xmlns="http://www.w3.org/1999/xhtml">
      <head>
        ...
        <style type="text/css">
          :root {--vp-c-green-soft: rgba(16, 185, 129, .14);--vp-c-brand-1: #3451b2;--vp-c-brand-2: #3a5ccc;}
          @media screen and (prefers-color-scheme: dark) { :root {--vp-c-green-soft: rgba(16, 185, 129, .16);--vp-c-brand-1: #a8b1ff;--vp-c-brand-2: #5c73e7;} }
      ...
      <body>
        <h1 title="共 {$totalNum} 链接">站点地图</h1>
        <ol>

...
{{ $frontmatter.description }} [官方文档](https://pay.weixin.qq.com/docs/partner/apis/entrusted-payment/partner/partner-query-deduct-schedule.html)

```js twoslash
// @filename: virtual.ts
/// <reference types="node" />
import { AxiosRequestConfig, AxiosPromise } from 'axios'
namespace WeChatPay.OpenAPI.V3.Papay.Pay.Partner.Schedules.ContractId._contract_id_.GetHttpMethod {
...
// ---cut---
wxpay.v3.papay.pay.partner.schedules.contractId._contract_id_.get({
//                                                            ^^^
  contract_id,
  params,
})

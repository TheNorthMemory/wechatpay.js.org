 ...
 * @prop {string} remark
 * @prop {{openid: string}} [qr_recharge_info]
 * @prop {{bill_no: string, memo: string, bank_name: string, bank_card_tail: string}} [bank_transfer_info]
 */

...
namespace WeChatPay.OpenAPI.V3.Capital.Capitallhh.Banks.CorporateBanking.GetHttpMethod {
...
namespace WeChatPay.OpenAPI.V3.Capital.Capitallhh.Banks {
  export interface CorporateBanking {
    /**
     * 查询支持对公业务的银行列表API
     * @link https://pay.weixin.qq.com/wiki/doc/apiv3_partner/Offline/apis/chapter11_2_3.shtml
     */
    get(config: CorporateBanking.GetHttpMethod.RequestConfig): AxiosPromise<CorporateBanking.GetHttpMethod.WellformedResponse>
  }
}
namespace WeChatPay.OpenAPI.V3.Capital.Capitallhh {
  export interface Banks {
    corporateBanking: Banks.CorporateBanking
  }
}
...
// ---cut---
wxpay.v3.capital.capitallhh.banks.corporateBanking.get({
//                                                 ^^^
  params,
})
.then(

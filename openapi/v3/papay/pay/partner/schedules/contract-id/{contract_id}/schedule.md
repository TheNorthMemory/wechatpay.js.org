...
{{ $frontmatter.description }} [官方文档](https://pay.weixin.qq.com/docs/partner/apis/entrusted-payment/partner/partner-schedule-deduction.html)

```js twoslash
// @filename: virtual.ts
/// <reference types="node" />
import { AxiosRequestConfig, AxiosPromise } from 'axios'
namespace WeChatPay.OpenAPI.V3.Papay.Pay.Partner.Schedules.ContractId._contract_id_.Schedule.PostHttpMethod {
...
namespace WeChatPay.OpenAPI.V3.Papay.Pay.Partner.Schedules {
...
// ---cut---
wxpay.v3.papay.pay.partner.schedules.contractId._contract_id_.schedule.post({
//                                                                     ^^^^
  sp_appid,
  sub_mchid,
  sub_appid,

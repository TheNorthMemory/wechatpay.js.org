...
{{ $frontmatter.description }} [官方文档](https://pay.weixin.qq.com/docs/merchant/apis/payscore-plan/sign-plan-notice.html) [官方文档](https://pay.weixin.qq.com/docs/partner/apis/partner-payscore-plan/sign-plan-notice.html)
...
```json
{
  ...
  "event_type":"PAYSCORE.USER_SIGN_PLAN",
  "resource" : {
 ...
 * @prop {'PAYSCORE.USER_SIGN_PLAN'} event_type
